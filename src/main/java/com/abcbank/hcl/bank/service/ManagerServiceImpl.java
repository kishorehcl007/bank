 ...
 * 
 * import com.abcbank.hcl.bank.dto.CustomerRegistrationRequest; import
 * com.abcbank.hcl.bank.model.Customer; import
 * com.abcbank.hcl.bank.repository.CustomerRepository;
 * 
 ...
 * 
 * 
 * //method to create user and save user to repo //charan public void
 * registratingCoustmer(CustomerRegistrationRequest customerRegistrationRequest)
 * {
 * 
 * 
 * //create a new user Customer currentCustomer = new Customer();
 * 
 ...
 * ()); currentCustomer.setCustomerPassword(customerRegistrationRequest.
 * getCustomerPassword());
 ...
 * );
 * 
 * //zero for new customer currentCustomer.setAccountBalance(0);
 ...
 * 
 * 
 * customerRepository.save(currentCustomer); //end of method
 * registrationCoustmer }
 * 
 * 
 * @Override public Customer getcustomerByName(String customerName) { // TODO
 * Auto-generated method stub return
 * customerRepository.findByCustomerName(customerName); }
 * 
 * 
 * @Override public Customer getCustomerByAccountNumber(Long accountNumber) { //
